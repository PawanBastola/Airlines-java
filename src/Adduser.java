...
public class Adduser {
	Adduser() {
		...
		JLabel emp = new JLabel("Emp ID:");
		emp.setBounds(290, 10, 100, 30);

		JTextField emptextfield = new JTextField();
		emptextfield.setBounds(400, 10, 120, 30);
		...
		phone.setBounds(290, 55, 100, 30);

		JTextField phonetextfield = new JTextField();
		phonetextfield.setBounds(400, 55, 120, 30);
		...
		email.setBounds(290, 95, 100, 30);

		JTextField emailtextfield = new JTextField();
		emailtextfield.setBounds(400, 95, 120, 30);
		...
		adduser.setBounds(440, 170, 150, 30);

		account_register.add(adduser);
		...
		adduser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				try {
					...
					int sempid = Integer.parseInt(emptextfield.getText().toString());
					...
					String sqlemp = "INSERT INTO `employee` VALUES('" + sempid + "','" + fname + "','" + lname + "','"
							+ sgender + "','" + sphone + "','" + semail + "','" + sdob + "','" + saddress + "')";

					connect.append(sqlemp, "of employee also recorded");
